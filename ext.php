...
namespace phpbbstudio\emoji;

/**
 * phpBB Studio - Emoji Extension base
 */
class ext extends \phpbb\extension\base
{
	...
	protected function get_language()
	{
		...
		$user->add_lang_ext('phpbbstudio/emoji', 'ext_require');
	...
	protected function enable_failed()
	{
		...
		$language->add_lang('ext_require', 'phpbbstudio/emoji');
